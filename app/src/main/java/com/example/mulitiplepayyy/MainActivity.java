package com.example.mulitiplepayyy;
...
public class MainActivity extends AppCompatActivity {
    ...
    String payeeAddress="vnhjb@upi";
    EditText upi;
    EditText amount1;
    EditText sender;
    String payeeName ;
    String transactionNote = "Hello ";
    String amount ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView pay = findViewById(R.id.pay);
        amount1=findViewById(R.id.amount);
        upi=findViewById(R.id.upi);
        sender=findViewById(R.id.sender);
       // payeeAddress=upi.getText().toString();
        amount=amount1.getText().toString();
      //  payeeName=upi.getText().toString();

        pay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("upi://pay?pa="+upi.getText().toString()+"&pn="+upi.getText().toString()+"&tn="+transactionNote+sender.getText().toString()+"!"+
